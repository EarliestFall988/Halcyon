...
namespace Lib.WorldItems
{
    ...
    public class Character
    {
        ...
        /// <returns></returns>
        public static PhysicsCharacterController CreatePhysicsPlayer(ContentManager Content)
        {
            ...
            PhysicsCharacterController character = new PhysicsCharacterController(new Vector2(128, 256) / 2)
            {
                Atlas = playerTextures,
                States = new Dictionary<string, CharacterState>()
                {
